                            ...
                            <div className='section-wrapper flex-row scr-center'>
                                ...
                                <div className='content'>
                                    ...
                                    <p>思春期になると、脳のうから「ホルモンをだしなさい」<br/>
                                        という命令が出るようになります。<br/>
                                        男の子は<span className='jishoword' onClick={() => {setShowModal(!showModal); setWord("精巣")}}>精巣</span>から<span className='keyword'>「男性ホルモン」</span>、<br/>
                                        女の子は<span className='jishoword' onClick={() => {setShowModal(!showModal); setWord("卵巣")}}>卵巣</span>から<span className='keyword'>「女性ホルモン」</span>。<br/>
